                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h4>Update Grade Course</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form method="post" action="{{route('gradeCrudUpdateRequest')}}">
                                    @csrf
                                    <div class="form-group mb-4">
                                        <label for="formGroupExampleInput">Course </label>
                                        <input name="course" type="text" class="form-control" id="formGroupExampleInput" value="{{$info->course}}">
                                    </div>
                                    <div >
                                        <label for="formGroupExampleInput">Grade </label>
                                        <select name="grade" class="form-control form-control-lg">
                                            <option value="{{$info->grade_id}}">{{$info->grade->grade}}</option>
