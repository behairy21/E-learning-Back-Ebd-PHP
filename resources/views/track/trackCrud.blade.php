                    ...
                    <table class="table table-bordered table-hover table-condensed mb-4">
                        ...
                        @foreach($data as $course)
                            <tr>
                                <td>{{$i++}}</td>
                                <td>{{$course->track}}</td>
                                <td>{{$course->tracks->track}}</td>
                                <td class="text-center">
                                    <ul class="table-controls">
                                        <form action="trackCrudUpdate" method="get">
                                            @csrf
                                        ...
                                        <form action="{{route('trackCrudDel')}}" method="post">
                                            @csrf
